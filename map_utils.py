...
class DetectionMAP(object):
    ...
    def accumulate(self):
        ...
        arr_scores = np.asarray(self.class_score_poss)
        arr_gt_counts = np.asarray(self.class_gt_counts)
        print("[accumulate]: score_poss_shape:{}, gt_counts_shape:{}".format(arr_scores.shape, arr_gt_counts))
